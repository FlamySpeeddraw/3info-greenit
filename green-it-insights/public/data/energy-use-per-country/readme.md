...
This data package contains the data that powers the chart ["Energy use per person"](https://ourworldindata.org/explorers/energy?hideControls=false&Total+or+Breakdown=Total&Energy+or+Electricity=Primary+energy&Metric=Per+capita+consumption&country=USA~GBR~CHN~OWID_WRL~IND~BRA~ZAF) on the Our World in Data website. It was downloaded on June 26, 2026.

### Active Filters

A filtered subset of the full data was downloaded. The following filters were applied:
- country: USA, GBR, CHN, OWID_WRL, IND, BRA, ZAF
